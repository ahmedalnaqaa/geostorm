...
use Todo\Bundle\UserBundle\Form\Transformer\RestoreRolesTransformer;
use Todo\Bundle\UserBundle\Security\EditableRolesBuilder;
...
/**
 * @DI\Service("todo.user.form.type.security_roles")
 * @DI\Tag("form.type")
 */
class SecurityRolesType extends AbstractType
{
    ...
    /**
     * @DI\InjectParams({
     *      "rolesBuilder" = @DI\Inject("todo.user.editable_role_builder"),
     * })
     *
